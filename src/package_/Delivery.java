...
public class Delivery extends Car {
    ...
    public Delivery(String mark, int distance){
        super(mark, distance, CarType.DELIVERY);
    ...
    public Delivery(Delivery delivery) {
        super(delivery.getMark(), delivery.getDistance(), delivery.getType());
    ...
    public String toString() {
        ...
        if (super.getDistance() <= this.distanceWithBasicPrice) return super.getMark() + ", type: " + super.getType().toString().toLowerCase() + ", how many: " + super.getDistance() + " km, " + "price " + df.format(this.price);
        return super.getMark() + ", type: " + super.getType().toString().toLowerCase() + ", how many: " + super.getDistance() + " km, " + df.format(this.price) + " (until " + distanceWithBasicPrice + "), " + df.format(priceAfterXKM) + " (from " + (distanceWithBasicPrice + 1) + ")";
    }
