...
public class Free extends Car {
    ...
    public Free(String brand, Integer distance) {
        super(brand, distance, CarType.FREE);
    ...
    public Free(Free free) {
        super(free.getBrand(), free.getDistance(), free.getType());
        this.maxDistance = free.getMaxDistance();
        this.price = free.getPrice();
    }

    @Override
    public String toString() {return super.getBrand() + ", type: " + super.getType().toString().toLowerCase() + ", how many: " + super.getDistance() + ", price " + df.format(this.price);}
